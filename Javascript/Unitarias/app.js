const {
  checkAndGeneratePhone,
  checkAndGenerateMail,
  createElement,
  checkAndGenerateAge,
} = require("./util");
...
const addAge = () => {
  ...
  const outputText = checkAndGenerateAge(newUserNameInput.value, newUserAgeInput.value);
...
const addPhone = () => {
  ...
  const outputText = checkAndGeneratePhone(newUserNameInput.value, newUserPhoneInput);
